module.exports = app => {
    ...
    // router.post('/client/resourceIssue/uploadResourceCover', controller.clientresourceIssue.uploadResourceCover); // 上传封面图片
    ...
    // router.post('/client/material/exportMaterials', controller.personal.exportMaterials); // 个人成果材料导出
